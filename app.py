...
model = keras.models.load_model("C:/BMEII/rsweb/my_model.h5")
...
def upload_file():
    ...
    if file and file.filename.endswith('.wav'):
        ...
        #extract mfcc and wavelet from audio file
        mfcc, wavelet= [], []
        path = filepath
        ...
        return predicted_labels  # Pass the prediction to the template
